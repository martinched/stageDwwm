...
<br>
    ...
    <input required id='form-cout_reparation' type='number' name="cout_reparation"/> €
<br>
<label for="temps_passe">Temps passé:</label>
<input id="form-temps_passe" type="text" required pattern="[0-9]{2}(:[0-9]{2})?"
       value="00:00" title="Écrire une durée au format hh ou hh:mm" onfocus="verifierDuree()">
    <p id="output"></p>
<br>
