...
<html>
	...
	<meta name="viewport" content="initial-scale=1.0">
        <title>Vue globale des ventes</title>
    ...
    <body>
	<header>
	    <h2>Vue globale des ventes</h2>
	    <a class="boutonTableauProduits" href="./vueGlobaleProduit.php"><= Tableau des produits ?</a>
	</header>
	<container>
	    <table>
		<thead>
			...
			<th><button onclick="filterBy('benne')">Benne</button></th>
	                <th><button onclick="filterBy('date_vente')">Date sortie</button></th>
			<th><button onclick="filterBy('prix_libre')">Prix</button></th>
		    </tr>
		</thead>
